...
.controller('creditoCtrl', function($scope, $firebaseArray, $ionicPopup, $timeout,esAdminVal, $crypto,Creditos,Usuarios,$cordovaBarcodeScanner) {
  ...
  $scope.cargarCredito= function(codigo){
    ...
    var ref = new Firebase("https://batalla-naval-de-la-muerte.firebaseio.com/Creditos/");
    ...
    var refUser = new Firebase("https://batalla-naval-de-la-muerte.firebaseio.com/Usuarios/");
    ...
    $timeout(function(){      
      ...
      if(credito.cargar){
        var ref = new Firebase("https://batalla-naval-de-la-muerte.firebaseio.com/Creditos/" + credito.codCred);
          ref.update({
            user: firebase.auth().currentUser.displayName,
            usado:true        
          });

        var ref = new Firebase("https://batalla-naval-de-la-muerte.firebaseio.com/Usuarios/" + credito.codUser);
        ref.update({
