...
.factory("Usuarios", function($firebaseArray) {
  var infosRef = new Firebase("https://batalla-naval-de-la-muerte.firebaseio.com/Usuarios");
  return $firebaseArray(infosRef);
})

.factory("Creditos", function($firebaseArray) {
  var infosRef = new Firebase("https://batalla-naval-de-la-muerte.firebaseio.com/Creditos");
  return $firebaseArray(infosRef);
})
